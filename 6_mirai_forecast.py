...
# 合併預測與原始收入
origin_data = pd.read_excel('origin_data/yt_origin_data.xlsx')
compare_table = pd.DataFrame(origin_data[['Date','total_revenue']]).join(total_revenue_pred,rsuffix='_repeated')
